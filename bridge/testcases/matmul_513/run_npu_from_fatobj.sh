...
KERNEL_OBJ="${KERNEL_OBJ:-${SCRIPT_DIR}/matmul_513_kernel_ptoas_fatobj.o}"
...
"${BISHENG_BIN}" \
    ...
    -shared -Wl,-soname,libmatmul_513_kernel.so \
    -L "${ASCEND_HOME_PATH}/lib64" \
    -Wl,-rpath,"${ASCEND_HOME_PATH}/lib64" \
    -o "${BUILD_DIR}/libmatmul_513_kernel.so" \
    "${KERNEL_OBJ}" \
    "${BUILD_DIR}/launch.o" \
