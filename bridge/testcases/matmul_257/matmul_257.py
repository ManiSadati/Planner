...
def main():
    ...
    # Random initialization is disproportionately expensive in the operator
    # simulator and can consume the entire early-IR capture timeout.
    ...
    print("allclose:", torch.allclose(c, reference, atol=2e-2, rtol=2e-2))
